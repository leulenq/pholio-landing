...
const sections = [
  ...
  },
  {
    ...
    content: [
      `4a. Platform Services\nPholio is a software platform — not a talent agency, talent agent, or employment agency. Pholio provides tools that enable: (i) Talent to create, maintain, and publish professional portfolios; generate PDF comp cards; track portfolio analytics; and apply to Agencies; and (ii) Agencies to manage talent rosters, review applications, conduct interview scheduling, set reminders, and track commission arrangements. Pholio does not represent Talent, does not negotiate bookings, does not guarantee representation or placement, and is not a party to any agreement between Talent and Agencies. See Section 12 (Disclaimers) for the full disclaimer of warranties.`,
  ...
  },
  {
    ...
    content: [
      ...
      `6f. DMCA / Copyright Infringement\nWe respect intellectual property rights and expect users to do the same. If you believe content on the Platform infringes your copyright, please refer to our DMCA Policy (www.pholio.studio/dmca) for full takedown notice requirements and our designated Copyright Agent contact details. In summary, a valid DMCA notice must include: (i) your contact information; (ii) identification of the copyrighted work; (iii) identification of the allegedly infringing material and its location on the Platform; (iv) a statement of good-faith belief; and (v) a statement of accuracy and authority, signed under penalty of perjury. Submitting a false takedown notice may expose you to liability under 17 U.S.C. § 512(f).`,
    ],
  },
  {
    ...
    content: [
      ...
      `7e. AI Feature Consent\nIf you enable AI-assisted photo analysis, you consent to the transmission of selected portfolio images to Groq, Inc.'s inference API for automated quality assessment and curation recommendations. AI analysis results are advisory only; they do not affect your standing on the Platform. You may withdraw this consent at any time in your account settings. For a full description of all AI systems used on the Platform, their limitations, and your rights, see our AI Notice (www.pholio.studio/ai-notice).`,
      `7f. Community Guidelines\nAll Talent users must comply with our Community Guidelines (www.pholio.studio/community-guidelines), which govern acceptable content, prohibited material (including explicit content and CSAM), minors' safety requirements, and reporting obligations. The Community Guidelines are incorporated into these Terms by reference. Violation of the Community Guidelines may result in content removal and account termination.`,
    ],
  },
  {
    ...
    content: [
      ...
      `8d. Legitimate Agency Operations\nBy registering as an Agency, you represent that you are a legitimate talent management, modeling, casting, or entertainment agency operating in compliance with all applicable laws in your jurisdiction, including any licensing requirements for talent agents or managers. You may not use an Agency account to pose as a scout, request payment from talent for representation, or engage talent for purposes unrelated to professional representation.`,
      `8e. Community Guidelines\nAgency users must also comply with our Community Guidelines (www.pholio.studio/community-guidelines). In particular, Agencies may not use the Platform to engage in or facilitate fake scouting, exploitation, or any contact with minors outside of the professional evaluation context described in Section 8c.`,
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      `10a. Nature of AI Features\nThe Platform includes optional AI-powered features, including automated photo quality assessment and portfolio curation recommendations (processed via Groq, Inc.) and agency-talent match scoring (computed using OpenAI embeddings). These features are designed to assist you in presenting your portfolio effectively. All AI-generated recommendations and match scores are advisory only and do not constitute editorial judgments, professional opinions, or legally binding evaluations. For full details on our AI systems, see our AI Notice (www.pholio.studio/ai-notice).`,
  ...
  },
  {
    ...
    content: [
      ...
      `PHOLIO IS A SOFTWARE PLATFORM AND IS NOT AN EMPLOYMENT AGENCY, TALENT AGENT, BOOKING AGENT, STAFFING COMPANY, OR MANAGEMENT COMPANY. PHOLIO DOES NOT REPRESENT TALENT, DOES NOT NEGOTIATE BOOKINGS OR CONTRACTS ON BEHALF OF ANY USER, AND DOES NOT GUARANTEE THAT ANY TALENT WILL OBTAIN REPRESENTATION, BOOKINGS, EMPLOYMENT, OR INCOME AS A RESULT OF USING THE PLATFORM. WE MAKE NO REPRESENTATIONS REGARDING THE QUALITY, LEGITIMACY, CREDENTIALS, OR INTENTIONS OF ANY AGENCY USER ON THE PLATFORM. YOU ARE SOLELY RESPONSIBLE FOR EVALUATING ANY AGENCY OR TALENT WITH WHOM YOU CHOOSE TO ENGAGE.`,
    ],
  },
  {
