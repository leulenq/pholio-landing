      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="font-sans text-[#050505]/60 mb-2 leading-relaxed">
            If you have questions about these Terms and Conditions, contact our legal team. We respond within the period required by applicable law and otherwise within a reasonable time.
          </p>
          <a
