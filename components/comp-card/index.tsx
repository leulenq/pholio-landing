...
export default function SceneCompCard() {
  ...
  // `useMediaQuery`, not framer's `useReducedMotion()`: the latter reads the
  // real preference during the first client render while the server had none,
  // which hydrates the whole section as a mismatch. See useMediaQuery's note.
