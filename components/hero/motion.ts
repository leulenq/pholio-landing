...
/** Total height of the pinned stage, including the viewport it sticks in. */
...
export const FIGURE_RISE = {
  desktop: ["0vh", "0vh", "0vh", "0vh", "4vh", "22vh", "46vh"],
  mobile: ["0vh", "0vh", "0vh", "0vh", "4vh", "14vh", "28vh"],
} as const;
