...
const EVENTS = [
  { agency: "Wilhelmina", action: "opened your book", time: "3h ago", dot: "#C9A55A" },
  { agency: "IMG Models", action: "saved you to a board", time: "Yesterday", dot: "#D4B96E" },
  { agency: "Elite Model", action: "pulled your comp", time: "2d ago", dot: "#BFA258" },
];
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 lg:px-12">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            >
              Views, saves, and board adds — time-stamped like call sheets. See
              which frames pulled attention so the next package you send is even
              sharper.
            </p>
            <p
            ...
            >
              Proof you were in the room, even when you weren’t.
            </p>
          </motion.div>
          ...
          >
            <div
              style={{
                ...
                boxShadow:
                  "0 30px 60px -15px rgba(0,0,0,0.12), 0 10px 30px -10px rgba(0,0,0,0.06)",
              }}
            >
              <div
                style={{
                  ...
                  {["Views", "Saves", "Boards"].map((t, i) => (
                    <span
                      ...
                      style={{
                        ...
                        fontSize: 9,
                        fontWeight: 500,
                        color: i === 0 ? "#C9A55A" : "rgba(255,255,255,0.2)",
                        letterSpacing: "0.06em",
                        textTransform: "uppercase",
                      }}
                    >
              ...
              <div style={{ padding: "18px 18px 0", display: "flex", gap: 16 }}>
                {[
                  { val: "142", lbl: "Views", trend: "+23%", up: true },
                  { val: "23", lbl: "Saves", trend: "+12%", up: true },
                  { val: "8", lbl: "Boards", trend: "+4", up: true },
                ].map((s) => (
                  <div
                    key={s.lbl}
                    style={{
                  ...
                  >
                    <div
                      className="font-editorial"
                      style={{ fontSize: 24, color: "white", lineHeight: 1 }}
                    >
                      {s.val}
                    </div>
                    <div
                  ...
                  {BARS.map((h, i) => (
                    <motion.div
                      ...
                      style={{
                        ...
                        background:
                          i >= BARS.length - 4
                            ? "linear-gradient(to top, rgba(201,165,90,0.6), rgba(201,165,90,0.15))"
              ...
              <div style={{ padding: "0 18px 16px" }}>
                ...
                {EVENTS.map((ev, i) => (
                  <motion.div
                    ...
                    animate={inView ? { opacity: 1, x: 0 } : {}}
                    transition={{ duration: 0.4, delay: 0.8 + i * 0.15, ease }}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      gap: 8,
                      ...
                      marginBottom: 3,
                      backgroundColor:
                        i === 0 ? "rgba(201,165,90,0.04)" : "transparent",
                      border:
                        i === 0
                          ? "1px solid rgba(201,165,90,0.06)"
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: 6,
                        borderRadius: "50%",
                        backgroundColor: ev.dot,
                        boxShadow:
                          i === 0 ? `0 0 8px ${ev.dot}40` : "none",
                        flexShrink: 0,
                      }}
                    />
                    <span
